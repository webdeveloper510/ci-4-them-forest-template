									...
									<div class="text-wrap">
										<div class="example">
											<div class="list-group">
												<a class="list-group-item list-group-item-action flex-column align-items-start active" href="#">
													<span class="d-flex">
														<img alt="" class="mr-3 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/3.jpg'); ?>">
														<div class="">
															<div class="d-flex w-100 justify-content-between">
																<h5 class="mb-2 tx-14">List group item heading</h5><small>3 days ago</small>
															</div>
												...
												<a class="list-group-item list-group-item-action flex-column align-items-start" href="#">
													<span class="d-flex">
														<img alt="" class="mr-3 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/8.jpg'); ?>">
														<div class="">
															<div class="d-flex w-100 justify-content-between">
																<h5 class="mb-2 tx-14">List group item heading</h5><small>3 days ago</small>
															</div>
												...
												<a class="list-group-item list-group-item-action flex-column align-items-start" href="#">
													<span class="d-flex">
														<img alt="" class="mr-3 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/11.jpg'); ?>">
														<div class="">
															<div class="d-flex w-100 justify-content-between">
																<h5 class="mb-2 tx-14">List group item heading</h5><small>3 days ago</small>
															</div>
										...
										<div class="example">
											<div class="list-group">
												<div class="list-group-item pd-y-20">
													<div class="media">
														<div class="d-flex mg-r-10 wd-50">
															<img class="mr-4 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/17.jpg'); ?>" alt="avatar">
														</div>
														<div class="media-body">
															<div class="media-body d-flex">
																<h6 class="tx-15 mb-2">Blake Vanessa</h6>
																<span class="tx-12 float-right ml-auto text-muted">4 hours ago</span>
															</div>
												...
												<div class="list-group-item pd-y-20">
													<div class="media">
														<div class="d-flex mg-r-10 wd-50">
															<img class="mr-4 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/5.jpg'); ?>" alt="avatar">
														</div>
														<div class="media-body">
															<div class="media-body d-flex">
																<h6 class="tx-15 mb-2">Elizabeth Parsons</h6>
																<span class="tx-12 float-right ml-auto text-muted">8 hours ago</span>
															</div>
															<p class="tx-13 mg-b-10 text-muted mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's .</p>
														</div>
													</div>
												...
												<div class="list-group-item pd-y-20">
													<div class="media">
														<div class="d-flex mg-r-10 wd-50">
															<img class="mr-4 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/12.jpg'); ?>" alt="avatar">
														</div>
														<div class="media-body">
															<div class="media-body d-flex">
																<h6 class="tx-15 mb-2">Nicola Lambert</h6>
																<span class="tx-12 float-right text-muted ml-auto">12 hours ago</span>
															</div>
															<p class="tx-13 mg-b-10 text-muted mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's .</p>
														</div>
													</div>
								...
								<div class="card-body">
									...
									<div class="text-wrap">
										<div class="example">
											<ul class="list-group wd-md-100p users-list-group">
												<li class="list-group-item d-flex align-items-center">
													<img alt="" class="mr-3 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/5.jpg'); ?>">
													<div>
													...
													<div class="d-flex float-left ml-auto">
														<a href="#" class="btn btn-outline-light btn-icon mr-2">
												...
												<li class="list-group-item d-flex align-items-center">
													<img alt="" class="mr-3 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/6.jpg'); ?>">
													<div>
												...
												<li class="list-group-item d-flex align-items-center">
													<img alt="" class="mr-3 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/15.jpg'); ?>">
													<div>
														<h6 class="tx-15 mb-1 tx-inverse tx-semibold mg-b-0">Joel Mendez</h6><span class="d-block tx-13 text-muted">Premium Member</span>
													</div>
													<div class="d-flex float-left ml-auto">
												...
												<li class="list-group-item d-flex align-items-center">
													<img alt="" class="mr-3 rounded-circle avatar-md" src="<?php echo base_url('assets/img/faces/12.jpg'); ?>">
													<div>
										...
										<ul class="nav nav-tabs html-source" id="html-source-code8" role="tablist">
											<li class="nav-item">
												<a class="nav-link active mr-1 html-code" id="html-code8" data-toggle="tab" href="#html-code8" role="tab" aria-controls="html-code8" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
											</li>
										</ul>
	<!---Prism Pre code-->
