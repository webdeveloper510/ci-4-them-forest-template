									...
									<div class="card-body">
										...
										<div class="text-wrap">
											...
											<ul class="nav nav-tabs html-source" id="html-source-code6" role="tablist">
												<li class="nav-item">
													<a class="nav-link active mr-1 html-code" id="html-code6" data-toggle="tab" href="#html-code6" role="tab" aria-controls="html-code" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
												</li>
											</ul>
	<!-- Prism Precode -->
									...
									<div class="card-body">
										...
										<div class="text-wrap">
											...
											<ul class="nav nav-tabs html-source" id="html-source-code7" role="tablist">
												<li class="nav-item">
													<a class="nav-link active mr-1 html-code" id="html-code7" data-toggle="tab" href="#html-code7" role="tab" aria-controls="html-code7" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
												</li>
											</ul>
	<!-- Prism Precode -->
									...
									<div class="card-body">
										...
										<div class="text-wrap">
											...
											<ul class="nav nav-tabs html-source" id="html-source-code8" role="tablist">
												<li class="nav-item">
													<a class="nav-link active mr-1 html-code" id="html-code8" data-toggle="tab" href="#html-code8" role="tab" aria-controls="html-code" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
												</li>
											</ul>
	<!-- Prism Precode -->
