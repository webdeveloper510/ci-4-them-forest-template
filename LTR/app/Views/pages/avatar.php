										...
										<div class="example">
											<div class="demo-avatar-group">
												<div class="main-img-user avatar-xs">
													<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/2.jpg'); ?>">
												</div>
												<div class="main-img-user avatar-sm">
													<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/3.jpg'); ?>">
												</div>
												<div class="main-img-user">
													<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/4.jpg'); ?>">
												</div>
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/5.jpg'); ?>">
												</div>
												<div class="main-img-user avatar-lg">
													<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/6.jpg'); ?>">
												</div>
												<div class="main-img-user avatar-xl d-none d-sm-block">
													<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/7.jpg'); ?>">
												</div>
												<div class="main-img-user avatar-xxl d-none d-sm-block">
													<img alt="avatar" class="rounded-circle" src="<?php echo base_url('assets/img/faces/8.jpg'); ?>">
												</div>
											</div>
										</div>
										<ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
											<li class="nav-item">
												<a class="nav-link active mr-1 html-code" id="html-code1" data-toggle="tab" href="#html-code1" role="tab" aria-controls="html-code1" aria-selected="true"><i class="fab fa-html5 text-orange mr-2"></i>HTML</a>
											</li>
										</ul>
	<!-- Prism Precode -->
									...
									<div class="text-wrap">
										<div class="example">
											<div class="demo-avatar-group">
												...
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="square" src="<?php echo base_url('assets/img/faces/5.jpg'); ?>">
												</div>
												<div class="main-img-user avatar-md">
													<img alt="avatar" class="radius" src="<?php echo base_url('assets/img/faces/6.jpg'); ?>">
												</div>
											</div>
										</div>
											...
											<div class="example">
												<div class="demo-avatar-group">
													<div class="main-avatar avatar online">
														<img alt="avatar" class="rounded-circle avatar" src="<?php echo base_url('assets/img/faces/9.jpg'); ?>">
													</div>
