<?= $this->extend('layouts/main'); ?>
	...
	<?= $this->section('styles'); ?>
		...
		<link href="<?php echo base_url('assets/plugins/darggable/jquery-ui-darggable.css'); ?>" rel="stylesheet">
						...
						<div class="row row-sm">
							<div class="col-xl-4 col-sm-12 col-md-6  col-lg-4">
								...
								<div class="card custom-card card-draggable">
									<img alt="Image" class="img-fluid card-img-top" src="<?php echo base_url('assets/img/photos/1.jpg'); ?>">
									<div class="card-body">
	...
	<?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/plugins/darggable/jquery-ui-darggable.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/darggable/darggable.js'); ?>"></script>
