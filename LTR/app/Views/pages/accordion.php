									...
									<div aria-multiselectable="true" class="accordion accordion-dark" id="accordion2" role="tablist">
										...
										<div class="card mb-0">
											<div class="card-header" id="headingTwo22" role="tab">
												<a aria-controls="collapseTwo22" aria-expanded="true" class="collapsed" data-toggle="collapse" href="#collapseTwo22">Horizontal Navigation Menu Fold Animation</a>
											</div>
											<div aria-labelledby="headingTwo22" class="collapse" data-parent="#accordion2" id="collapseTwo22" role="tabpanel">
												<div class="card-body">
										...
										<div class="card mb-0">
											<div class="card-header" id="headingThree23" role="tab">
												<a aria-controls="collapseThree2" aria-expanded="false" class="collapsed" data-toggle="collapse" href="#collapseThree23">Creating CSS3 Button with Rounded Corners</a>
											</div>
											<div aria-labelledby="headingThree23" class="collapse" data-parent="#accordion2" id="collapseThree23" role="tabpanel">
												<div class="card-body">
													Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore.
												</div>
											</div><!-- collapse -->
								...
								<div class="card-body">
									<div class="panel-group1" id="accordion11">
										<div class="panel panel-default  mb-4">
											<div class="panel-heading1 bg-primary ">
												<h4 class="panel-title1">
													<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion11" href="#collapseFour1" aria-expanded="false"><i class="fe fe-arrow-right mr-2"></i>Section 1</a>
												</h4>
											</div>
										...
										<div class="panel panel-default mb-0">
											<div class="panel-heading1  bg-primary">
												<h4 class="panel-title1">
													<a class="accordion-toggle mb-0 collapsed" data-toggle="collapse" data-parent="#accordion11" href="#collapseFive2" aria-expanded="false"><i class="fe fe-arrow-right mr-2"></i>Section 2</a>
												</h4>
											</div>
											...
											<div class="accor bg-primary" id="headingOne1">
												<h4 class="m-0">
													<a href="#collapseOne1" class="" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">
													   <i class="si si-cursor-move mr-2"></i>Accordions With Text
													</a>
												</h4>
											</div>
											...
											<div class="accor  bg-primary" id="headingTwo2">
												<h4 class="m-0">
													<a href="#collapseTwo2" class="collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapseTwo">
														<i class="si si-cursor-move mr-2"></i>Accordions with images
													</a>
												</h4>
											</div>
												...
												<div class="border p-3">
													<div class="row">
														<div class="col-lg-3 col-md-6">
															<img class="img-fluid rounded mb-2 mb-lg-0" src="<?php echo base_url('assets/img/photos/8.jpg'); ?>" alt="banner image">
														</div>
														<div class="col-lg-3 col-md-6">
															<img class="img-fluid rounded mb-2 mb-lg-0" src="<?php echo base_url('assets/img/photos/10.jpg'); ?>" alt="banner image ">
														</div>
														<div class="col-lg-3 col-md-6">
															<img class="img-fluid rounded mb-2 mb-lg-0" src="<?php echo base_url('assets/img/photos/11.jpg'); ?>" alt="banner image ">
														</div>
														<div class="col-lg-3 col-md-6">
															<img class="img-fluid rounded mb-2 mb-lg-0" src="<?php echo base_url('assets/img/photos/12.jpg'); ?>" alt="banner image ">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="accor  bg-primary" id="headingThree3">
												<h4 class="m-0">
													<a href="#collapseThree1" class="collapsed" data-toggle="collapse" aria-expanded="false" aria-controls="collapseThree">
														<i class="si si-cursor-move mr-2"></i>Accordions with tables
													</a>
												</h4>
											</div>
