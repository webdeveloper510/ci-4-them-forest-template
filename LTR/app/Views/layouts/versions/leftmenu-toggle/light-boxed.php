...
<html lang="en" dir="ltr">
	<head>
        ...
        <?= $this->include('layouts/layoutsections/leftmenu-toggle/boxed-styles'); ?>
    ...
    <body class="main-body app sidebar-mini">
        ...
        <div class="page">
            ...
            <?= $this->include('layouts/layoutsections/leftmenu-toggle/main-header'); ?>

            <?= $this->include('layouts/layoutsections/leftmenu-toggle/main-sidebar'); ?>

            <!-- main-content -->
			<div class="main-content toggle-content">
		...
		<!-- End Page -->
            ...
            <?= $this->include('layouts/layoutsections/leftmenu-toggle/scripts'); ?>
