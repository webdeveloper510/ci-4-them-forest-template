								...
								<div class="card-body">
									...
									<div class="main-icon-group main-icon-list">
										<ul class="icons-list">
											...
											<li class="icons-list-item"><i class="icon iion-ios-flash-off"></i></li>
								...
								<div class="card-body">
									...
									<div class="main-icon-group main-icon-list">
										<ul class="icons-list">
											...
											<li class="icons-list-item"><i class="lnr lnr-pie-chart"></i></li>
											<li class="icons-list-item"><i class="lnr lnr-pie-chart-2"></i></li>
