<?= $this->extend('layouts/main'); ?>
	...
	<?= $this->section('styles'); ?>
		...
		<link href="<?php echo base_url('assets/plugins/select2/css/select2.min.cs'); ?>" rel="stylesheet">
		...
		<link rel="stylesheet" href="<?php echo base_url('assets/plugins/sumoselect/sumoselect-rtl.css'); ?>">

		<!--Internal  TelephoneInput css-->
		<link rel="stylesheet" href="<?php echo base_url('assets/plugins/telephoneinput/telephoneinput-rtl.css'); ?>">
								...
								<div class="card-body">
									...
									<div class="row mb-4">
										...
										<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
											<input type="file" class="dropify" data-default-file="<?php echo base_url('assets/img/photos/1.jpg'); ?>" data-height="200"  />
										</div>
										<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
