<?= $this->extend('layouts/custommain'); ?>
	...
	<?= $this->section('content'); ?>
		...
		<!-- Page -->
		<div class=" error-page1 app sidebar-mini underconstruction-page">
			<div class="page">
						...
						<div class="col-md-5 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
							<div class="row wd-100p mx-auto text-center">
								<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
									<img src="<?php echo base_url('assets/img/media/underconstruction.png'); ?>" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
								</div>
							</div>
						</div>
						<!-- The content half -->
												...
												<div>
													...
													<div class="input-group mt-5 text-center sub-input mt-1 ml-auto mr-auto mt-6">
														...
														<div class="input-group-append ">
															<button type="button" class="btn btn-danger-gradient btn-lg bl-tr-3  bl-br-3">
																Subscribe
															</button>
														</div>
													</div>
	...
	<?= $this->section('custom-scripts'); ?>
		...
		<!--- Jquery.Coutdown js --->
		<script src="<?php echo base_url('assets/plugins/jquery-countdown/jquery.lwtCountdown-1.0.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jquery-countdown/count-down.js'); ?>"></script>
