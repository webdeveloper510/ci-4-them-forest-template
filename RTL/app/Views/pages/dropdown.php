											...
											<div class="row row-xs">
												<div class="col-sm-6 col-md-3">
													<div class="dropdown dropleft">
														<button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-info" data-toggle="dropdown" id="dropleftMenuButton" type="button">Dropright Menu<i class="fas fa-caret-right mr-1"></i></button>
												...
												<div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
													<div class="dropdown dropright">
														<button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-danger dropdown-toggle" data-toggle="dropdown" id="droprightMenuButton" type="button">Dropleft Menu</button>
