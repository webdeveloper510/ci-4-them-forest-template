<?= $this->extend('layouts/main'); ?>
	...
	<?= $this->section('scripts'); ?>
		...
		<script src="<?php echo base_url('assets/plugins/jqvmap/maps/jquery.vmap.canada.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jqvmap/maps/jquery.vmap.algeria.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jqvmap/maps/jquery.vmap.argentina.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jqvmap/maps/jquery.vmap.europe.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jqvmap/maps/jquery.vmap.germany.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jqvmap/maps/jquery.vmap.russia.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/jqvmap/maps/jquery.vmap.france.js'); ?>"></script>
		<script src="<?php echo base_url('assets/js/vector-map.js'); ?>"></script>
