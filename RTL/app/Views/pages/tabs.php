<?= $this->extend('layouts/main'); ?>
									...
									<div class="text-wrap">
										...
										<ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
											<li class="nav-item">
												...
												<a class="nav-link mr-1 html-code" id="js-tab1" data-toggle="tab" href="#default-tab1" role="tab" aria-controls="default-tab1" aria-selected="true"><i class="fab fa-node-js text-info ml-2"></i>JS</a>
												<a class="nav-link mr-1 html-code" id="js-tab2" data-toggle="tab" href="#default-tab2" role="tab" aria-controls="default-tab2" aria-selected="true"><i class="fab fa-node-js text-info ml-2"></i>JS</a>
											</li>
										</ul>
	...
	src="<?php echo base_url('assets/plugins/tabs/jquery.multipurpose_tabcontent.js'); ?>"</script></code></pre>
	<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i></div>
	</figure>
											</div>
	...
	src="<?php echo base_url('assets/js/tabs.js'); ?>"</script></code></pre>
	<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i></div>
	</figure>
											</div>
										</div>
	...
	<?= $this->section('scripts'); ?>
		...
		<!--- Tabs JS-->
		<script src="<?php echo base_url('assets/plugins/tabs/jquery.multipurpose_tabcontent.js'); ?>"></script>
