					...
					<div class="row row-sm">
						<div class="col-xl-3 col-lg-3 col-md-12 mb-3 mb-md-0">
							<div class="card">
								...
								<div class="card-header border-bottom border-top pt-3 pb-3 mb-0 font-weight-bold text-uppercase rounded-0">Filter</div>
								<div class="card-body">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/01.jpg'); ?>" alt="product-image">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/02.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
												</a>
											</div>
											<div class="text-center pt-3">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/03.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
												</a>
											</div>
											<div class="text-center pt-3">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/06.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
												</a>
											</div>
											<div class="text-center pt-3">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/04.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart"></i>
												</a>
											</div>
											<div class="text-center pt-3">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/05.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
												</a>
											</div>
											<div class="text-center pt-3">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/09.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
												</a>
											</div>
											<div class="text-center pt-3">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/11.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
												</a>
											</div>
											<div class="text-center pt-3">
									...
									<div class="card">
										<div class="card-body h-100">
											<div class="pro-img-box">
												...
												<img class="w-100" src="<?php echo base_url('assets/img/ecommerce/07.jpg'); ?>" alt="product-image">
												<a href="#" class="adtocart"> <i class="las la-shopping-cart "></i>
												</a>
											</div>
											<div class="text-center pt-3">
