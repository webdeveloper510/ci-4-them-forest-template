									...
									<div class="row row-sm ">
										<div class=" col-xl-5 col-lg-12 col-md-12">
											<div class="preview-pic tab-content">
											  <div class="tab-pane active" id="pic-1"><img src="<?php echo base_url('assets/img/ecommerce/shirt-5.png'); ?>" alt="image"/></div>
											  <div class="tab-pane" id="pic-2"><img src="<?php echo base_url('assets/img/ecommerce/shirt-2.png'); ?>" alt="image"/></div>
											  <div class="tab-pane" id="pic-3"><img src="<?php echo base_url('assets/img/ecommerce/shirt-3.png'); ?>" alt="image"/></div>
											  <div class="tab-pane" id="pic-4"><img src="<?php echo base_url('assets/img/ecommerce/shirt-4.png'); ?>" alt="image"/></div>
											  <div class="tab-pane" id="pic-5"><img src="<?php echo base_url('assets/img/ecommerce/shirt-1.png'); ?>" alt="image"/></div>
											</div>
											<ul class="preview-thumbnail nav nav-tabs">
											  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="<?php echo base_url('assets/img/ecommerce/shirt-5.png'); ?>" alt="image"/></a></li>
											  <li><a data-target="#pic-2" data-toggle="tab"><img src="<?php echo base_url('assets/img/ecommerce/shirt-2.png'); ?>" alt="image"/></a></li>
											  <li><a data-target="#pic-3" data-toggle="tab"><img src="<?php echo base_url('assets/img/ecommerce/shirt-3.png'); ?>" alt="image"/></a></li>
											  <li><a data-target="#pic-4" data-toggle="tab"><img src="<?php echo base_url('assets/img/ecommerce/shirt-4.png'); ?>" alt="image"/></a></li>
											  <li><a data-target="#pic-5" data-toggle="tab"><img src="<?php echo base_url('assets/img/ecommerce/shirt-1.png'); ?>" alt="image"/></a></li>
											</ul>
										</div>
					...
					<div class="row">
							...
							<div class="card item-card">
								<div class="card-body pb-0 h-100">
									<div class="text-center">
										<img src="<?php echo base_url('assets/img/ecommerce/01.jpg'); ?>" alt="img" class="img-fluid">
									</div>
						...
						<div class="col-lg-3">
							<div class="card item-card">
								<div class="card-body pb-0 h-100">
									<div class="text-center">
										<img src="<?php echo base_url('assets/img/ecommerce/04.jpg'); ?>" alt="img" class="img-fluid">
									</div>
									<div class="card-body cardbody relative">
										<div class="cardtitle">
											<span>Fashion</span>
						...
						<div class="col-lg-3">
							<div class="card item-card">
								<div class="card-body pb-0 h-100">
									<div class="text-center">
										<img src="<?php echo base_url('assets/img/ecommerce/07.jpg'); ?>" alt="img" class="img-fluid">
									</div>
									<div class="card-body cardbody relative ">
										<div class="cardtitle">
						...
						<div class="col-lg-3">
							<div class="card item-card">
								<div class="card-body pb-0 h-100">
									<div class="text-center">
										<img src="<?php echo base_url('assets/img/ecommerce/08.jpg'); ?>" alt="img" class="img-fluid">
									</div>
									<div class="card-body cardbody relative">
										<div class="cardtitle">
											<span>Accessories</span>
