<?= $this->extend('layouts/main'); ?>
	...
	<?= $this->section('styles'); ?>
		...
		<!--Internal   Notify -->
		<link href="<?php echo base_url('assets/plugins/notify/css/notifIt.css'); ?>" rel="stylesheet"/>

		<!--Internal  treeview -->
        <link href="<?php echo base_url('assets/plugins/treeview/treeview.css'); ?>" rel="stylesheet" type="text/css" />
	...
	<?= $this->section('scripts'); ?>
		...
		<!--Internal  Notify js -->
		<script src="<?php echo base_url('assets/plugins/notify/js/notifIt-rtl.js'); ?>"></script>
		<script src="<?php echo base_url('assets/plugins/notify/js/notifit-custom.js'); ?>"></script>
