					...
					<div class="container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="<?php echo base_url('pages/index'); ?>"><img src="<?php echo base_url('assets/img/brand/logo.png'); ?>" class="logo-1" alt="logo"></a>
								<a href="<?php echo base_url('pages/index'); ?>"><img src="<?php echo base_url('assets/img/brand/logo-white.png'); ?>" class="dark-logo-1" alt="logo"></a>
								<a href="<?php echo base_url('pages/index'); ?>"><img src="<?php echo base_url('assets/img/brand/favicon.png'); ?>" class="logo-2" alt="logo"></a>
								<a href="<?php echo base_url('pages/index'); ?>"><img src="<?php echo base_url('assets/img/brand/favicon.png'); ?>" class="dark-logo-2" alt="logo"></a>
							</div>
									...
									<div class="dropdown  nav-itemd-none d-md-flex">
										...
										<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
											<a href="#" class="dropdown-item d-flex ">
												<span class="avatar  ml-3 align-self-center bg-transparent"><img src="<?php echo base_url('assets/img/flags/french_flag.jpg'); ?>" alt="img"></span>
												<div class="d-flex">
													<span class="mt-2">French</span>
												</div>
											</a>
											<a href="#" class="dropdown-item d-flex">
												<span class="avatar  ml-3 align-self-center bg-transparent"><img src="<?php echo base_url('assets/img/flags/germany_flag.jpg'); ?>" alt="img"></span>
												<div class="d-flex">
													<span class="mt-2">Germany</span>
												</div>
											</a>
											<a href="#" class="dropdown-item d-flex">
												<span class="avatar ml-3 align-self-center bg-transparent"><img src="<?php echo base_url('assets/img/flags/italy_flag.jpg'); ?>" alt="img"></span>
												<div class="d-flex">
													<span class="mt-2">Italy</span>
												</div>
											</a>
											<a href="#" class="dropdown-item d-flex">
												<span class="avatar ml-3 align-self-center bg-transparent"><img src="<?php echo base_url('assets/img/flags/russia_flag.jpg'); ?>" alt="img"></span>
												<div class="d-flex">
													<span class="mt-2">Russia</span>
												</div>
											</a>
											<a href="#" class="dropdown-item d-flex">
												<span class="avatar  ml-3 align-self-center bg-transparent"><img src="<?php echo base_url('assets/img/flags/spain_flag.jpg'); ?>" alt="img"></span>
												<div class="d-flex">
							...
							<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown main-profile-menu nav nav-item nav-link">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="<?php echo base_url('pages/page-signin'); ?>"><i class="bx bx-log-out"></i> Sign Out</a>
									</div>
								</div>
