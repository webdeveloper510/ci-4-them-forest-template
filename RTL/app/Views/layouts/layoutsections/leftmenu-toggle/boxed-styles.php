	...
	<link href="<?php echo base_url('assets/plugins/bootstrap/css/bootstrap.min.css'); ?>" rel="stylesheet"/>
        ...
        <!--  Toggle-sidemenu css -->
        <link href="<?php echo base_url('assets/css-rtl/sidemenu-responsive-tabs.css'); ?>" rel="stylesheet" />
        ...
        <!-- Animations css -->
        <link href="<?php echo base_url('assets/css-rtl/animate.css'); ?>" rel="stylesheet">