				...
				<div class="container">
					<div class="main-header-left ">
						...
						<div class="main-header-center  mr-4">
							<input class="form-control" placeholder="Search..." type="search"><button class="btn"><i class="fe fe-search"></i></button>
						</div>
					</div><!-- search -->
					<a class="header-brand header-brand2 d-none d-lg-block" href="<?php echo base_url('pages/index'); ?>">
						<img src="<?php echo base_url('assets/img/brand/logo-white.png'); ?>" class="desktop-dark">
						<img src="<?php echo base_url('assets/img/brand/logo.png'); ?>" class="desktop-logo">
						<img src="<?php echo base_url('assets/img/brand/favicon.png'); ?>" class="desktop-logo-1">
						<img src="<?php echo base_url('assets/img/brand/favicon-white.png'); ?>" class="desktop-logo-dark">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="<?php echo base_url('pages/signin'); ?>"><i class="bx bx-log-out"></i> Sign Out</a>
								</div>
							</div>
