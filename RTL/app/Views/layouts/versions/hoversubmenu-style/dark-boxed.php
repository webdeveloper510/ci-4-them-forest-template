...
<html lang="en" dir="ltr">
	<head>
        ...
        <?= $this->include('layouts/layoutsections/hoversubmenu-style/boxed-styles'); ?>

	</head>

    <body class="hoversubmenu main-body app sidebar-mini dark-theme">
		...
		<!-- End Page -->
            ...
            <?= $this->include('layouts/layoutsections/hoversubmenu-style/scripts'); ?>
